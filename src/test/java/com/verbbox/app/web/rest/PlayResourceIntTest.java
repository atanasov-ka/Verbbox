...
public class PlayResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_LAST_ACTIVIRY = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_LAST_ACTIVIRY = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public void getAllPlays() throws Exception {
        ...
        restPlayMockMvc.perform(get("/api/plays?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].lastActiviry").value(hasItem(sameInstant(DEFAULT_LAST_ACTIVIRY))));
    }
    ...
    public void getPlay() throws Exception {
        ...
        restPlayMockMvc.perform(get("/api/plays/{id}", play.getId()))
            ...
            .andExpect(jsonPath("$.lastActiviry").value(sameInstant(DEFAULT_LAST_ACTIVIRY)));
    }
